...
QT_MOC_LITERAL(1, 5, 7), // "removed"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 5), // "Task*"
QT_MOC_LITERAL(4, 20, 4), // "task"
QT_MOC_LITERAL(5, 25, 13), // "statusChanged"
QT_MOC_LITERAL(6, 39, 6), // "rename"
QT_MOC_LITERAL(7, 46, 7) // "checked"

    },
    "Task\0removed\0\0Task*\0task\0statusChanged\0"
    "rename\0checked"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removed((*reinterpret_cast< Task*(*)>(_a[1]))); break;
        case 1: _t->statusChanged((*reinterpret_cast< Task*(*)>(_a[1]))); break;
        ...
        {
            typedef void (Task::*_t)(Task * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::removed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Task::*_t)(Task * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::statusChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Task::statusChanged(Task * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
